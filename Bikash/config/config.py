...
BOT_ID = int(getenv("BOT_ID", "7628056885"))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/KASHIBRAND/Bgtplayer")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+_qPchBV5z4VjMjM1")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+_qPchBV5z4VjMjM1")
